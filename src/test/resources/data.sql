-- Password are in the format: Password<UserLetter>123<SpecialCharacter>. Unless specified otherwise.
-- Encrypted using https://www.javainuse.com/onlineBcrypt
INSERT INTO local_user (email, first_name, last_name, password, user_name, email_verified)
    VALUES ('UserA@Junit.com', 'UserA-FirstName', 'UserA-LastName', '$2a$10$UngOMvABFFfD4PIY8ireNO45SHUVQVdrPQx/jBgUqpbabiiGmh3se', 'UserA', true)
    , ('UserB@Junit.com', 'UserB-FirstName', 'UserB-LastName', '$2a$10$XYo.40yydPQC89wbW1xjGOEqwMNDaR2VgnQnfJJ2RD8WUyEJwJ1iy', 'UserB', false)
    , ('UserC@junit.com', 'UserC-FirstName', 'UserC-LastName', '$2a$10$SYiYAIW80gDh39jwSaPyiuKGuhrLi7xTUjocL..NOx/1COWe5P03.', 'UserC', false);

INSERT INTO address(address_line_1, city, country, user_id, is_active)
VALUES ('123 Tester Hill', 'Testerton', 'England', 1, true)
